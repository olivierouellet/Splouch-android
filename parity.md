...
**`P-16` was seen running on 2026-09-22** — the prompt, the handshake, the switch and
three ways of failing, on the Medium Phone AVD against a local cloud and a local Pi; its
row carries what was on screen. **One thing in it cannot be checked from here:** whether
